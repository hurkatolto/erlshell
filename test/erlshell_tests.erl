...
get_commands_test() ->
    lists:foreach(
      fun check_get_commands_result/1,
      [{{["cmd1", "cmd2"], "cmd3"}, "cmd1.cmd2.cmd3"},
       {{["2.2", "3.5"], "4.5"}, "2.2.3.5.4.5"}
       ]).

check_get_commands_result({Expected, Line}) ->
    ?assertEqual(Expected, erlshell:get_commands(Line)).
